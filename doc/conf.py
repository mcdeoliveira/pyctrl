...
# -*- coding: utf-8 -*-
#
# pyctrl documentation build configuration file, created by
...
project = 'pyctrl: a Python Suite for Systems and Control'
...
man_pages = [
    (master_doc, 'pyctrl', 'pyctrl Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'pyctrl', 'pyctrl Documentation',
     author, 'pyctrl', 'One line description of project.',
     'Miscellaneous'),
]
